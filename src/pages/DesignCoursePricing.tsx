...
if (typeof document !== 'undefined') {
  ...
  if (!document.head.querySelector('style[data-checkbox-animations]')) {
    styleElement.setAttribute('data-checkbox-animations', 'true');
...
const DesignCoursePricing = () => {
  const navigate = useNavigate();
  const [modules, setModules] = useState<CourseModule[]>([
    { id: 1, title: "Фотографія та обробка фото", price: 4650, selected: true },
    { id: 2, title: "Креативне письмо та сторітелінг", price: 3720, selected: false },
    { id: 3, title: "Основи каліграфії та леттерінгу", price: 2420, selected: true },
    { id: 4, title: "Основи дизайну та інтер'єру", price: 5000, selected: true },
    { id: 5, title: "Основи графічного дизайну у Figma", price: 5400, selected: false },
    { id: 6, title: "Відеомонтаж", price: 5830, selected: false },
    { id: 7, title: "Веб-дизайн, базовий UI/UX", price: 6830, selected: true }
  ]);
    ...
    <div style={{ width: '100vw', minHeight: '100vh', background: '#121212', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          Оберіть модулі, які б ви бажали вчити
        </div>
...
export default DesignCoursePricing;
