...
import ProgrammingImage from '../assets/CoursesPres/chromed arm.png';
...
const ProgrammingCourse = () => {
  ...
  const courseModules = [
    {
      title: "АІ Tools для креаторів: від ідей до візуалу",
      subsections: [
        "Знайомство з D-ID для створення говорящих аватарів",
        "ElevenLabs - генерація реалістичного голосу",
        "Suno - створення музики за допомогою AI",
        "Інтеграція AI-інструментів у проекти",
        "Етичні аспекти використання AI"
      ]
    },
    {
      title: "No-code сайти: створення лендінгів у Tilda або Webflow",
      subsections: [
        "Основи роботи з конструктором Tilda",
        "Створення адаптивних сторінок у Webflow",
        "Налаштування форм та взаємодії",
        "Оптимізація для пошукових систем",
        "Публікація та домени"
      ]
    },
    {
      ...
      subsections: [
        ...
        "Семантичні теги та доступність",
        "CSS селектори та каскадність",
        "Flexbox та Grid Layout",
        "Адаптивний дизайн та медіа-запити"
      ]
    },
    {
      title: "Програмування в Scratch",
      subsections: [
        "Основи блокового програмування",
        "Створення анімацій та ігор",
        "Робота зі змінними та циклами",
        "Умовні конструкції",
        "Публікація проектів у спільноті"
      ]
    },
    {
      title: "Код для соцмереж",
      subsections: [
        "Створення інтерактивних постів",
        "Розробка міні-додатків для Instagram",
        "Ігри для Telegram боті",
        "AR-фільтри для соціальних мереж",
        "Аналітика та метрики залучення"
      ]
    }
  ];
      ...
      <main className="relative">
            ...
            <div className="flex flex-col lg:flex-row items-start">
              ...
              <div className="w-full lg:w-1/2 lg:pl-16">
                <div className="text-white text-base md:text-lg lg:text-xl leading-relaxed" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 400 }}>
                  Робота з AI-інструментами (D-ID, ElevenLabs, Suno та інші)
                  <br/><br/>
                  Створення сайтів у Tilda, Webflow (no-code)
                  <br/><br/>
                  Основи HTML/CSS — верстка та стилізація сторінок
                  <br/><br/>
                  Програмування на Scratch — візуальне блокове кодування
                  <br/><br/>
                  Інтерактивна розробка для соцмереж (міні-додатки, іграшки)
                </div>
              </div>
            </div>
        ...
        <section className="px-4 md:px-8 lg:px-20 py-8 md:py-12 lg:py-16">
          ...
          <div className="flex justify-center mt-8 md:mt-12 lg:mt-16">
            <button
              onClick={() => navigate('/courses/programming-pricing')}
