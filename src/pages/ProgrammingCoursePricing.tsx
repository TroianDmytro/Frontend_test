...
if (typeof document !== 'undefined') {
  ...
  if (!document.head.querySelector('style[data-checkbox-animations-programming]')) {
    styleElement.setAttribute('data-checkbox-animations-programming', 'true');
...
const ProgrammingCoursePricing = () => {
  const navigate = useNavigate();
  const [modules, setModules] = useState<CourseModule[]>([
    { id: 1, title: "Основи веб-розробки HTML/CSS", price: 3800, selected: true },
    { id: 2, title: "JavaScript та інтерактивні елементи", price: 4500, selected: false },
    { id: 3, title: "React: сучасна фронтенд розробка", price: 6200, selected: true },
    { id: 4, title: "No-code платформи: Tilda та Webflow", price: 4200, selected: true },
    { id: 5, title: "Python: основи програмування", price: 5400, selected: false },
    { id: 6, title: "AI-інструменти для розробників", price: 4600, selected: false },
    { id: 7, title: "Розробка додатків для соціальних мереж", price: 5800, selected: true }
  ]);
    ...
    <div style={{ width: '100vw', minHeight: '100vh', background: '#121212', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          Оберіть модулі програмування, які б ви бажали вчити
        </div>
...
export default ProgrammingCoursePricing;
